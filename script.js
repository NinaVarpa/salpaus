...
document.querySelector('.merkinta').addEventListener('click',=>{
  ...
  if(document.querySelector('#teht_a').checked){document.querySelector('.boksit').children[0].inner.innerHTML='<li class"sisalto"><input type="checkbox id="teht_a"checked>Tehtävä A ontehty!</li>';
  }
  else{
    document.guerySelector('.boksit').children[0].innerHTML='<li class="sisalto"><input type="checkbox" id="teht_a">Tehtävä A</li>';
  }
   if(document.querySelector('#teht_b').checked){document.querySelector('.boksit').children[0].inner.innerHTML='<li class"sisalto"><input type="checkbox id="teht_b"checked>Tehtävä B ontehty!</li>';
  }
  else{
